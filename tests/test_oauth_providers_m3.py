...
def test_every_provider_is_registered():
    assert set(P.REGISTRY) == {
        ...
        "anyapi", "apollo", "pdl", "akta", "hunter", "createos", "sumble", "moltsets", "openmart", "harvestapi", "dropleads", "quickenrich", "prospeo", "aiark", "wiza", "limadata", "getleadsio", "scrubby", "zerobounce", "datagma", "contactout", "millionverifier", "bounceban", "trykitt", "crunchbase", "tikhub", "brightdata", "semrush", "justoneapi",
        "scrapecreators",
