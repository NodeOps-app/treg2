...
| [CreateOS Sandbox — own-key catalog and lifecycle tools](architecture/createos.md) | implemented locally; direct live calls passed; vendor review pending | oauth_providers.py, createos.yaml, capabilities.yaml, createos.svg, … |
